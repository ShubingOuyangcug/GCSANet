...
# Datasets
parser.add_argument('-train', '--trainroot', default='/media/wtl/tw/NWPU/NWPU_FLOW/flow28_1/train.txt', type=str) #new_shu_label
parser.add_argument('-val', '--valroot', default='/media/wtl/tw/NWPU/NWPU_FLOW/flow28_1/valid.txt', type=str)
...
# Checkpoints
parser.add_argument('-c', '--checkpoint', default='/media/wtl/tw/NWPU/NWPU_FLOW/flow28_2/weights/res18_16_AA_adam', type=str, metavar='PATH',
