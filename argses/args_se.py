...
# Datasets
parser.add_argument('-train', '--trainroot', default='/run/media/cug/00077CE80009E4AD/tw/bishe/256flow/flow82_21/train.txt', type=str) #new_shu_label
parser.add_argument('-val', '--valroot', default='/run/media/cug/00077CE80009E4AD/tw/bishe/256flow/flow82_21/valid.txt', type=str)
...
# Checkpoints
parser.add_argument('-c', '--checkpoint', default='/run/media/cug/00077CE80009E4AD/tw/bishe/256flow/flow82_21/weights/se201__full_2fc_nols', type=str, metavar='PATH',
