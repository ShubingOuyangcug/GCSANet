...
# Datasets
parser.add_argument('-train', '--trainroot', default='/mnt/data/tw/bishe/256flow/flow55_2/train.txt', type=str) #new_shu_label
parser.add_argument('-val', '--valroot', default='/mnt/data/tw/bishe/256flow/flow55_2/valid.txt', type=str)
...
# Checkpoints
parser.add_argument('-c', '--checkpoint', default='/mnt/data/tw/bishe/256flow/flow55_2/weights/res50_mut', type=str, metavar='PATH',
