...
# Datasets
parser.add_argument('-train', '--trainroot', default='/media/wtl/00077CE80009E4AD/tw/NWPU/NWPU_FLOW/flow19_1/train.txt', type=str) #new_shu_label
parser.add_argument('-val', '--valroot', default='/media/wtl/00077CE80009E4AD/tw/NWPU/NWPU_FLOW/flow19_1/valid.txt', type=str)
...
# Checkpoints
parser.add_argument('-c', '--checkpoint', default='/media/wtl/00077CE80009E4AD/tw/NWPU/NWPU_FLOW/flow19_0/weights/sedense121_adam_ls', type=str, metavar='PATH',
                    help='path to save checkpoint (default: checkpoint)')
parser.add_argument('--resume', default='', type=str, metavar='PATH',
                    help='path to latest checkpoint (default: none)')
# Architecture
parser.add_argument('--arch', '-a', metavar='ARCH', default='se_densenet121',
                    choices=model_names,
