...
# Datasets
parser.add_argument('-train', '--trainroot', default='/media/wtl/00077CE80009E4AD/tw/AID/flow55_1/train.txt', type=str) #new_shu_label
parser.add_argument('-val', '--valroot', default='/media/wtl/00077CE80009E4AD/tw/AID/flow55_1/valid.txt', type=str)
...
# Checkpoints
parser.add_argument('-c', '--checkpoint', default='/media/wtl/00077CE80009E4AD/tw/AID/AID_FLOW/flow55_1/se_dense121_adam_ls', type=str, metavar='PATH',
