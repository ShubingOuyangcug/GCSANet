...
####  path  size  classnum savepath 注意类别啊啊啊啊啊啊啊啊啊啊啊啊啊啊

# Parse arguments
parser = argparse.ArgumentParser(description='PyTorch ImageNet Training')

# Datasets
parser.add_argument('-train', '--trainroot', default='/run/media/cug/00077CE80009E4AD/tw/ucm/datas/flow55_2/train.txt', type=str) #new_shu_label
parser.add_argument('-val', '--valroot', default='/run/media/cug/00077CE80009E4AD/tw/ucm/datas/flow55_2/valid.txt', type=str)
...
# Checkpoints
parser.add_argument('-c', '--checkpoint', default='/run/media/cug/00077CE80009E4AD/tw/ucm/datas/flow55_2/weights/dense121_adam', type=str, metavar='PATH',
