...
####  path  size  classnum savepath

# Parse arguments
parser = argparse.ArgumentParser(description='PyTorch ImageNet Training')

# Datasets
parser.add_argument('-train', '--trainroot', default='/run/media/cug/00077CE80009E4AD/tw/NWPU/NWPU_FLOW/flow28_1/train.txt', type=str) #new_shu_label
parser.add_argument('-val', '--valroot', default='/run/media/cug/00077CE80009E4AD/tw/NWPU/NWPU_FLOW/flow28_1/valid.txt', type=str)
...
parser.add_argument('--num-classes', default=45, type=int, metavar='N',
...
# Checkpoints
parser.add_argument('-c', '--checkpoint', default='/run/media/cug/00077CE80009E4AD/tw/NWPU/NWPU_FLOW/flow28_1/weights/resnext50_32x4d_camax_adam', type=str, metavar='PATH',
                    help='path to save checkpoint (default: checkpoint)')
parser.add_argument('--resume', default='', type=str, metavar='PATH',
                    help='path to latest checkpoint (default: none)')
# Architecture
parser.add_argument('--arch', '-a', metavar='ARCH', default='resnext50_32x4d',
                    choices=model_names,
