...
# Datasets
parser.add_argument('-train', '--trainroot', default='/media/wtl/00077CE80009E4AD/tw/AID/AID_FLOW/flow55_0/train.txt', type=str) #new_shu_label
parser.add_argument('-val', '--valroot', default='/media/wtl/00077CE80009E4AD/tw/AID/AID_FLOW/flow55_0/valid.txt', type=str)
...
parser.add_argument('--num-classes', default=30, type=int, metavar='N',
...
# Checkpoints
parser.add_argument('-c', '--checkpoint', default='/media/wtl/00077CE80009E4AD/tw/AID/AID_FLOW/flow55_0/weights/se_DENSE121_FULL_adam', type=str, metavar='PATH',
