...
# Datasets
parser.add_argument('-train', '--trainroot', default='/run/media/cug/00077CE80009E4AD/tw/bishe/256flow/flow55_2/train.txt', type=str) #new_shu_label
parser.add_argument('-val', '--valroot', default='/run/media/cug/00077CE80009E4AD/tw/bishe/256flow/flow55_2/valid.txt', type=str)
...
# Checkpoints
parser.add_argument('-c', '--checkpoint', default='/run/media/cug/00077CE80009E4AD/tw/bishe/256flow/flow55_2/weights/res18_16_AA_adam', type=str, metavar='PATH',
