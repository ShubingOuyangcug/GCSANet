...
import dataset
from argses.args_ucm82 import args
...
from losses.label_smooth import LabelSmoothSoftmaxCEV2
...
def main():
    ...
    criterion = LabelSmoothSoftmaxCEV2(lb_smooth=0.1, lb_ignore=255).cuda()
